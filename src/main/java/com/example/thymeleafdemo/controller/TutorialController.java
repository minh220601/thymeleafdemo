...
import com.example.thymeleafdemo.entity.Tutorial;
import com.example.thymeleafdemo.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public String saveTutorial(Tutorial tutorial, RedirectAttributes redirectAttributes){
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "Saved Tutorial!");
        } catch (Exception e) {
    ...
    public String deleteTutorial(@PathVariable("id") Integer id, Model model, RedirectAttributes redirectAttributes){
        try{
            ...
            redirectAttributes.addFlashAttribute("message", "Deleted Tutorial with id=" + id + "!");
        } catch (Exception e){
            redirectAttributes.addFlashAttribute("message", e.getMessage());
        }
    ...
    public String updateTutorialPublishedStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean published,
        ...
        try{
            ...
            String message = "Tutorial id=" + id + " has been " + status;
